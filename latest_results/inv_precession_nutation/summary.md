...
|------------|---|---|---|---|
| inv_precession_nutation | N×P composed matrix (eraNum06a × pure eraBp06-r... | N×P composed via bundled ERFA (num06a × bp06-rp) | ln_get_equ_prec + ln_get_equ_nut sequenced / ap... | EquatorialMeanJ2000 ↔ EquatorialTrueOfDate via ... |
