...
|------------|---|---|---|
| inv_bias_precession | IAU 2006 bias+precession product (eraBp06 → rbp... | IAU 2006 bias+precession via bundled ERFA | ICRS ↔ EquatorialMeanOfDate via composed frame ... |
