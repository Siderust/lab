...
|------------|---|---|---|---|---|
| obliquity | Pure Rx(±ε₀) rotation using eraObl06(J2000) | Built-in J2000 ↔ ECLIPJ2000 obliquity rotation | Pure Rx(±ε₀) using erfa.obl06(J2000) | ln_get_equ_from_ecl / ln_get_ecl_from_equ at J2... | EclipticMeanJ2000 ↔ EquatorialMeanJ2000 via Tra... |
