...
|------------|---|---|---|---|
| inv_icrs_ecl_tod | Transpose of eraEcm06(date) matrix | Transpose of erfa.ecm06(date) | ln_get_equ_from_ecl(date) + ln_get_equ_prec2(da... | EclipticTrueOfDate → ICRS via FromEclipticTrueO... |
