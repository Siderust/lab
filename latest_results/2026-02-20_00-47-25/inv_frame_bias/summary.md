...
|------------|---|---|---|
| inv_frame_bias | Transpose of IAU 2006 frame bias matrix (eraBp0... | Transpose of IAU 2006 frame bias via bundled ERFA | EquatorialMeanJ2000 → ICRS via frame rotation p... |
