...
|------------|---|---|---|---|
| inv_nutation | Transpose of IAU 2000A nutation matrix (eraNum0... | Transpose of IAU 2000A nutation via bundled ERFA | Approximate inverse via ΔRA/ΔDec subtraction (I... | EquatorialTrueOfDate → EquatorialMeanOfDate via... |
