...
|------------|---|---|---|---|
| precession_nutation | N×P composed matrix (eraPmat06 × eraNum06a / tr... | N×P composed via bundled ERFA | ln_get_equ_prec + ln_get_equ_nut sequenced / ap... | EquatorialMeanJ2000 ↔ EquatorialTrueOfDate via ... |
